...
n_estimators=72 #10, 72, 100
oob_score=True
random_state = 789654123

clf_0 = RandomForestClassifier(n_estimators=n_estimators, oob_score=oob_score, random_state=random_state)
clf_0.fit(X_train, Y_train[:, 0])

clf_1 = RandomForestClassifier(n_estimators=n_estimators, oob_score=oob_score, random_state=random_state)
clf_1.fit(X_train, Y_train[:, 1])

clf_2 = RandomForestClassifier(n_estimators=n_estimators, oob_score=oob_score, random_state=random_state)
clf_2.fit(X_train, Y_train[:, 2])

clf_3 = RandomForestClassifier(n_estimators=n_estimators, oob_score=oob_score, random_state=random_state)
